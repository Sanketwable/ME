...
func Load() {
	...
	err = db.Debug().AutoMigrate(&models.User{}, &models.StudentInfo{},&models.FacultyInfo{}, models.TempOTP{}, models.Qualification{}, models.Class{}, models.ClassStudent{}, models.Assignment{}, models.FileAssignment{}, models.FormAssignment{}, models.Question{}, models.StudentAssignment{}).Error
	if err != nil {
