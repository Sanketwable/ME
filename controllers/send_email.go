...
func SendOTPEmail(to string, otp string, subject string) error {
	...
	m.SetBody("text/html",
		`
		   ...
		   <div>If you did not raise this request, please write to&nbsp;<a href="mailto:prod.pdjt@gmail.com" target="_blank" rel="noopener">support@nursdinc.com</a></div>
		   <div>
		   <p>&nbsp;</p>
		   <p>&nbsp;</p>
	...
	d := gomail.NewPlainDialer(host, 587, fromEmail, fromEmailPassword)
...
// SendInterviewEmail is a func
func SendInterviewEmail(to string, link string, subject string, time time.Time) error {
	...
	m.SetBody("text/html",
		`
		   <p style="text-align: center; font-size: 40px;"><span style="color: #666699;">Nursd</span></p>
		   <hr />
		   <div style="text-align: center;"><span style="color: #333300;">Interview Link</span></div>
		   <div>Hello,</div>
		   <div>&nbsp; &nbsp;Please open the below link for interview:</div>
		   <div style="text-align: center; font-size: 20px;"><strong>
		   <div>zoom <a href=` + link + `target="_blank" rel="noopener">link</a></div>
		   </strong></div>
		   <div>&nbsp;</div>
		   <div><span style="color: #999999; font-size: 10px;">Valid @ `+ time.String() + `</span></div>
		   <div>If you did not raise this request, please write to&nbsp;<a href="mailto:support@nursdinc.com" target="_blank" rel="noopener">support@nursdinc.com</a></div>
		   <div>
		   <p>&nbsp;</p>
		   <p>&nbsp;</p>
		   <table style="border-color: rgba(0, 0, 0, 0); width: 700px; height: 40px; margin-left: auto; margin-right: auto;">
...
// SendUpdatedInterviewEmail is a func
func SendUpdatedInterviewEmail(to string, link string, subject string, time time.Time) error {
	...
	m.SetBody("text/html",
		`
		   ...
		   <div>&nbsp; &nbsp;Please open the below link for interview:</div>
		   <div style="text-align: center; font-size: 20px;"><strong>
		   <div>Updated zoom <a href=` + link + `target="_blank" rel="noopener">link</a></div>
		   </strong></div>
		   <div>&nbsp;</div>
		   <div><span style="color: #999999; font-size: 10px;">Valid @ `+ time.String() + `</span></div>
		   <div>If you did not raise this request, please write to&nbsp;<a href="mailto:support@nursdinc.com" target="_blank" rel="noopener">support@nursdinc.com</a></div>
